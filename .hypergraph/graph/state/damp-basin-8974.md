...
flywheel:
  ...
  content_sha256: 7a73b471fe6e78c38e31e7558938ef99bb6aadbd5a6965876a017a816c07a3e2
...
- **The front door is rewritten structure-first, by Operator directive** [rec: young-ivy-4144]: README.md went 281 → 132 lines, organized around the vision (an agent-native substrate), the structure (record graph → reconcile → views → frontier, with the sets-to-sets citation structure as the "why hypergraph" answer) and the four-verb discipline, with everything else reduced to pointers. Doc links are absolute GitHub URLs so the PyPI page — which renders the same file — resolves them; the pyproject `description` is two sentences. Both ship publicly at the 0.0.13 publication. The install doc test still pins the Install/Quickstart order.
...
- young-ivy-4144 — the structure-first README rewrite and the PyPI summary cut
